...
mod internal {
    ...
    impl<'d> serde_core::ser::SerializeSeq for SerializeDocumentArray<'d> {
        type Ok = ();
        type Error = Error;
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_document(
                self.dst,
                self.settings,
                serde_core::ser::SerializeSeq::end(self.inner),
            )
        }
    }

    impl<'d> serde_core::ser::SerializeTuple for SerializeDocumentArray<'d> {
        type Ok = ();
        type Error = Error;
        ...
        where
            T: serde_core::ser::Serialize,
        {
            serde_core::ser::SerializeTuple::serialize_element(&mut self.inner, value)
                .map_err(Error::wrap)
        }
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_document(
                self.dst,
                self.settings,
                serde_core::ser::SerializeTuple::end(self.inner),
            )
        }
    }

    impl<'d> serde_core::ser::SerializeTupleVariant for SerializeDocumentArray<'d> {
        type Ok = ();
        type Error = Error;
        ...
        where
            T: serde_core::ser::Serialize,
        {
            serde_core::ser::SerializeTupleStruct::serialize_field(&mut self.inner, value)
                .map_err(Error::wrap)
        }
    ...
    impl<'d> serde_core::ser::SerializeTupleStruct for SerializeDocumentArray<'d> {
        type Ok = ();
        type Error = Error;
    ...
    impl<'d> serde_core::ser::SerializeMap for SerializeDocumentTable<'d> {
        ...
        where
            T: serde_core::ser::Serialize,
        {
            serde_core::ser::SerializeMap::serialize_value(&mut self.inner, value)
                .map_err(Error::wrap)
        }
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_document(
                self.dst,
                self.settings,
                serde_core::ser::SerializeMap::end(self.inner),
            )
        }
    }
    ...
    impl<'d> serde_core::ser::SerializeStruct for SerializeDocumentTable<'d> {
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_document(
                self.dst,
                self.settings,
                serde_core::ser::SerializeStruct::end(self.inner),
            )
        }
    }
    ...
    impl<'d> serde_core::ser::SerializeSeq for SerializeValueArray<'d> {
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_value(self.dst, serde_core::ser::SerializeSeq::end(self.inner))
        }
    }
    ...
    impl<'d> serde_core::ser::SerializeTuple for SerializeValueArray<'d> {
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_value(self.dst, serde_core::ser::SerializeTuple::end(self.inner))
        }
    }

    impl<'d> serde_core::ser::SerializeTupleVariant for SerializeValueArray<'d> {
        type Ok = ();
        type Error = Error;
    ...
    impl<'d> serde_core::ser::SerializeMap for SerializeValueTable<'d> {
        type Ok = ();
        type Error = Error;
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_value(self.dst, serde_core::ser::SerializeMap::end(self.inner))
        }
    }

    impl<'d> serde_core::ser::SerializeStruct for SerializeValueTable<'d> {
        type Ok = ();
        type Error = Error;
        ...
        fn end(self) -> Result<Self::Ok, Self::Error> {
            write_value(self.dst, serde_core::ser::SerializeStruct::end(self.inner))
        }
    }
