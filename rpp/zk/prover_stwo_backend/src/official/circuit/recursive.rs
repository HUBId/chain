...
impl RecursiveCircuit {
    ...
    const EXPECTED_DIGEST_LENGTH: usize = DOMAIN_TAG_LENGTH + DIGEST_LENGTH;
    ...
    fn aggregate_with_params(
        ...
        let final_inputs = vec![previous, state_digest, pruning_fold, activity_digest];
