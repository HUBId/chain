...
/// Snapshot of ledger state commitments anchoring recursive aggregation proofs.
...
fn fold_commitments(parameters: &StarkParameters, commitments: &[String]) -> FieldElement {
...
fn compute_recursive_commitment(
    ...
    let activity_digest = fold_commitments(parameters, &all_commitments);
...
/// Lightweight helper for aggregating recursive proof commitments.
#[derive(Clone, Debug)]
