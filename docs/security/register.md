...
| Tier policy persistence drift | Unpersisted policy changes weaken witness tier isolation and allow bypass of rate controls. | Append-only log landed; dual-control workflow automation remains outstanding. | Network Operations | [ENG-923](../status/weekly.md#tier-policy-persistence) |
