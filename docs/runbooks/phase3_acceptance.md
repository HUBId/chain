...
- [ ] **Timetoke-SLO-Bericht archiviert.** Das Nightly-Artefakt `timetoke-slo-report` (aus `cargo xtask report-timetoke-slo`) dokumentiert Erfolgsquote und Latenz der letzten sieben Tage und verweist auf die SLO-Grenzen im Timetoke-Observability-Runbook.【F:.github/workflows/nightly.yml†L1-L80】【F:docs/observability/timetoke.md†L1-L120】
