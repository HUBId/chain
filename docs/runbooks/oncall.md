...
2. **Runbooks nach Kategorie.** Snapshot-Ausfälle folgen dem
   ...
   [Observability-Runbook](./observability.md). Für Checksummenfehler,
   Tier-Drift oder fehlende Dual-Genehmigungen ziehst du zusätzlich das
   [Incident Response Playbook](./incident_response.md) heran. Erfasse alle Links im Incident-Log, damit die Phase‑3-Checkliste
   vollständig bleibt.【F:docs/runbooks/network_snapshot_failover.md†L1-L176】【F:docs/runbooks/admission.md†L1-L120】【F:docs/runbooks/incident_response.md†L1-L120】【F:docs/runbooks/phase3_acceptance.md†L8-L62】
...
2. **Audit-Einträge sammeln.** `curl -sS -H "Authorization: Bearer ${RPP_RPC_TOKEN}" "${RPP_RPC_URL}/p2p/admission/audit?offset=0&limit=50" | jq .`
   ...
   auf, hake die passende Checkliste im [Incident Response Playbook](./incident_response.md#tier-policy-drift-erkennen) ab
   und referenziere ihn in der Phase‑3-Checkliste.【F:rpp/rpc/src/routes/p2p.rs†L110-L209】【F:docs/runbooks/incident_response.md†L78-L116】【F:docs/runbooks/phase3_acceptance.md†L13-L42】
