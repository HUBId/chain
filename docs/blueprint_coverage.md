...
| Libp2p Backbone | `p2p.snapshot_sync` | In Arbeit – Timetoke-Snapshot-Producer/-Consumer hängen am neuen Snapshot-Stream, Replay-Prüfungen binden Pruning-Receipts ein und Regressionstests decken Roundtrip sowie Angriffspfade ab.【F:rpp/consensus/src/timetoke/snapshots.rs†L55-L205】【F:rpp/consensus/src/timetoke/replay.rs†L15-L248】【F:tests/consensus/timetoke_snapshots.rs†L48-L168】【F:docs/consensus/timetoke.md†L1-L28】 |
| Malachite BFT | `consensus.malachite_distributed` | Done – Der `DistributedOrchestrator` bündelt Proposal-, Vote- und Commit-Streams für mehrere Validatoren, während der `TopicRouter` Commit-Nachrichten automatisch an die Witness-Themen weiterleitet. Tests dokumentieren den Mehrknoten-Fanout und begleiten die Blueprint-Dokumentation.【F:rpp/consensus/src/malachite/distributed.rs†L1-L189】【F:rpp/consensus/src/network/topics.rs†L1-L62】【F:tests/consensus/malachite_distributed.rs†L1-L188】【F:docs/consensus/malachite.md†L1-L23】 |
| Wallet/STWO workflows | `wallet.utxo_policies`, `wallet.zsi_workflow`, `wallet.stwo_circuits`, `wallet.uptime_proofs` | `wallet.stwo_circuits` abgeschlossen: Wallet-Circuit-Bibliothek deckt Balance-, Double-Spend- und Tier-Nachweise ab, Tests spiegeln die Blueprint-Fälle wider.【F:rpp/proofs/blueprint/mod.rs†L135-L157】【F:rpp/wallet/blueprint/mod.rs†L26-L45】【F:prover/stwo/tests/circuit_fixtures.rs†L1-L61】【F:rpp/wallet/src/proofs/mod.rs†L1-L118】 `wallet.uptime_proofs` abgeschlossen: Node-Scheduler, Telemetrie und Reputation-Manager produzieren, prüfen und verteilen Uptimes; Konsens-Tests decken Krediterteilung und Slashing-Abzweige ab.【F:rpp/node/src/services/uptime.rs†L1-L209】【F:rpp/consensus/src/state.rs†L1-L420】【F:tests/consensus/uptime.rs†L1-L176】【F:docs/consensus/uptime_proofs.md†L1-L32】 |
