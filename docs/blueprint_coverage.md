...
| Plonky3 backend enablement | Roadmap Schritt 3 (Proof system phase) | **Open** – replace the stub prover/verifier with the vendor Plonky3 backend and re-enable the Plonky3 CI matrix once artifacts land.【F:rpp/proofs/plonky3/prover/mod.rs†L201-L233】【F:rpp/proofs/plonky3/verifier/mod.rs†L1-L120】 |
