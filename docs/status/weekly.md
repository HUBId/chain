...
| Compliance Evidence | Nightly-Artefakt `phase3-evidence-<timestamp>` bündelt Dashboards, Alerts, Audit-Logs, Policy-Backups, Checksum-Reports und CI-Logs inklusive Manifest. | ✅ aktiv | Nightly-Job [`phase3-evidence`](../../.github/workflows/nightly.yml#L79-L128) generiert das Paket via `cargo xtask collect-phase3-evidence`; das Manifest listet enthaltene sowie fehlende Nachweise.【F:.github/workflows/nightly.yml†L79-L128】【F:xtask/src/main.rs†L1484-L1851】 |
| Runbooks | Timetoke-Failover-Drill inklusive `cargo xtask report-timetoke-slo`, Snapshot-CLI-Transkripten und Evidence-Bundle-Ablage. | 🟡 ausstehend | [`docs/runbooks/timetoke_failover.md`](../runbooks/timetoke_failover.md), Nightly-Job [`snapshot-health`](../../.github/workflows/nightly.yml#L42-L78), Evidence-Bundle [`cargo xtask collect-phase3-evidence`](../../xtask/src/main.rs#L1484-L1564)【F:docs/runbooks/timetoke_failover.md†L41-L106】【F:.github/workflows/nightly.yml†L42-L128】【F:xtask/src/main.rs†L1016-L1043】【F:xtask/src/main.rs†L1484-L1564】 |
| Metriken & Tests | Snapshot-Checksum-Reports gegen Nightly `snapshot-health-report.json` und lokale CLI-Drills abgeglichen. | 🟡 geplant | Nightly-Job [`snapshot-health`](../../.github/workflows/nightly.yml#L42-L78), CLI `cargo xtask snapshot-health`, Evidence-Bundle `checksum-reports`.【F:.github/workflows/nightly.yml†L42-L78】【F:xtask/src/main.rs†L1034-L1054】【F:xtask/src/main.rs†L1771-L1812】 |
| Release | Manifest-Signaturen via `cosign verify-blob` im Job `plonky3-hash-audit` geprüft und als Evidence-Bundle-Log gesichert. | 🟡 geplant | Nightly-Job [`plonky3-hash-audit`](../../.github/workflows/nightly.yml#L130-L208), Evidence-Bundle `ci-logs`.【F:.github/workflows/nightly.yml†L130-L208】【F:xtask/src/main.rs†L1484-L1851】 |
