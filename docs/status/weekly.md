...
| Compliance Evidence | Nightly-Artefakt `phase3-evidence-<timestamp>` bündelt Dashboards, Alerts, Audit-Logs, Policy-Backups, Checksum-Reports und CI-Logs inklusive Manifest. | ✅ aktiv | Nightly-Job [`phase3-evidence`](../../.github/workflows/nightly.yml#L79-L128) generiert das Paket via `cargo xtask collect-phase3-evidence`; das Manifest listet enthaltene sowie fehlende Nachweise.【F:.github/workflows/nightly.yml†L79-L128】【F:xtask/src/main.rs†L1498-L1852】 |
