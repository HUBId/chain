...
| Compliance Evidence | Nightly-Artefakt `phase3-evidence-<timestamp>` bündelt Dashboards, Alerts, Audit-Logs, Policy-Backups, Checksum-Reports und CI-Logs inklusive Manifest. | ✅ aktiv | Nightly-Job [`phase3-evidence`](../../.github/workflows/nightly.yml#L79-L128) generiert das Paket via `cargo xtask collect-phase3-evidence`; das Manifest listet enthaltene sowie fehlende Nachweise.【F:.github/workflows/nightly.yml†L79-L128】【F:xtask/src/main.rs†L1498-L1899】 |
| Snapshot-Signaturen & SLOs | Alert-Matrix, Teststrategie und Evidence-Bundle decken Manifest-Signaturen (`snapshot-health`) sowie Timetoke-SLO-Reports ab. | ✅ produktiv | [`docs/test_validation_strategy.md`](../test_validation_strategy.md#snapshot--timetoke-automation), [`docs/runbooks/network_snapshot_failover.md`](../runbooks/network_snapshot_failover.md#alert-first-response-matrix), [`docs/runbooks/timetoke_failover.md`](../runbooks/timetoke_failover.md#alert-first-response-matrix), [`docs/observability/alerts`](../observability/alerts)【F:docs/test_validation_strategy.md†L128-L174】【F:docs/runbooks/network_snapshot_failover.md†L73-L120】【F:docs/runbooks/timetoke_failover.md†L18-L67】【F:docs/observability/alerts/snapshot_manifest.yaml†L1-L52】 |
