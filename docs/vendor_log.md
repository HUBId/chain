...
* Das SIMD-Backend ist nun komplett vendort: `prover/backend/simd/fft/` (IFFT/RFFT) und `prover/backend/simd/lookups/` (GKR/MLE) wurden aus dem Archiv übernommen, sodass alle Exporte aus `simd/mod.rs` auf vorhandene Implementierungen zeigen.【F:vendor/stwo-dev/0.1.1/staging/crates/stwo/src/prover/backend/simd/fft/mod.rs†L1-L128】【F:vendor/stwo-dev/0.1.1/staging/crates/stwo/src/prover/backend/simd/lookups/mod.rs†L1-L18】【F:vendor/stwo-dev/0.1.1/staging/crates/stwo/src/prover/backend/mod.rs†L11-L24】
* `scripts/vendor_stwo/update_manifest.py` wurde erneut ausgeführt; die Prüfsummenliste enthält nun die neuen SIMD-Dateien und das Manifest-Log dokumentiert den Abschluss des SIMD-Vendorings.【F:vendor/stwo-dev/0.1.1/manifest/final_file_list.txt†L2-L21】【F:vendor/stwo-dev/0.1.1/logs/update_manifest.log†L10-L12】
